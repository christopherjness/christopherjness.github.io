...
PairStyle(brownian/bmpoly,PairBrownianBmpoly)

#else

#ifndef LMP_PAIR_BROWNIAN_BMPOLY_H
#define LMP_PAIR_BROWNIAN_BMPOLY_H

#include "pair_brownian.h"

namespace LAMMPS_NS {

class PairBrownianBmpoly : public PairBrownian {
 public:
  PairBrownianBmpoly(class LAMMPS *);
  ~PairBrownianBmpoly() {}
